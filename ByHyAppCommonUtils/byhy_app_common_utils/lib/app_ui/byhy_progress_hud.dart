  ...
  if (toastType == _ToastType.text) {
    ...
    topWidget = Container(
      ...
      child: const CircularProgressIndicator(
        strokeWidth: 3.0,
        valueColor: AlwaysStoppedAnimation<Color>(ByHyColorUtil.WhiteColor),
      ),
    );
  } else {
    IconData? icon;
    ...
    topWidget = Container(
      ...
      margin: const EdgeInsets.only(bottom: 8.0),
      padding: const EdgeInsets.all(4.0),
      child: Icon(icon, size: 30, color: ByHyColorUtil.WhiteColor),
    );
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            loadingText,
            style:
                const TextStyle(fontSize: 16, color: ByHyColorUtil.WhiteColor),
