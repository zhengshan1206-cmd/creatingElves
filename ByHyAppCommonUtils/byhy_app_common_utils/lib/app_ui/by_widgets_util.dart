...
import '../byhy_app_common_utils.dart';
import 'byhy_no_data_view.dart';
import 'byhy_screen_utils.dart';
import 'dialog/by_dialog_util.dart';
...
class ByWidgetsUtil {
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
              fontSize: 14.sp,
              color: ByHyColorUtil.CommonTextColor.withOpacity(0.5),
            ),
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: bgColor ?? ByHyColorUtil.LoginBtnBgColor.withOpacity(0.05),
  ...
  /// 通用按钮组件
  static GestureDetector btnWithIcon({
    BuildContext? context,
    required String title,
    ...
    final netorkIcon = iconPath.startsWith("http");
    return GestureDetector(
      onTap: () {
        // FocusScope.of(context ?? navigatorKey.currentContext!).unfocus();
        onClick();
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if (iconPath.isNotEmpty) SizedBox(width: contentGap ?? 7.w),
            Text(
              title,
              style: TextStyle(
                color: textColor,
  ...
  /// 通用按钮组件
  static GestureDetector btnWithSvgIcon({
    BuildContext? context,
    required String title,
    required String iconPath,
    required void Function() onClick,
  ...
  static Text commonText({
    ...
    return Text(
      ...
      style: TextStyle(
        ...
        decorationColor:
        decorationColor ?? ByHyColorUtil.WhiteColor.withOpacity(0.5),
            ...
            desc: desc ??
                RichText(
                  text: TextSpan(
                    text: "暂无内容",
                    style: TextStyle(
                      color: ByHyColorUtil.CommonTextColor.withOpacity(0.6),
                      fontSize: 12.sp,
                    ),
                  ),
                )));
  ...
  static Widget commonListNoDataView({
    String? prompts,
    Color? promptsColor,
    Widget? bottomWidget,
    EdgeInsetsGeometry? padding,
        ...
        return ListView(
          ...
          children: [
            SizedBox(
              ...
              child: ByWidgetsUtil.commonNoData(
                prompts: prompts,
                promptsColor: promptsColor,
          ...
          NoDataView(
            ...
            desc: RichText(
              text: TextSpan(
                ...
                style: TextStyle(
                  color: promptsColor ??
                      ByHyColorUtil.CommonTextColor.withOpacity(0.5),
                  fontSize: 12.sp,
                ),
              ),
            ),
  ...
  static noDataView({
    ...
    return Container(
      ...
      alignment: Alignment.center,
      child: NoDataView(desc: desc),
    );
  }

  // static sliverNoDataView({
  //   RichText? desc,
  // }) {
  ...
  //                     text: "暂无内容",
  //                     style: TextStyle(
  //                       color: const Color.fromARGB(255, 74, 92, 163),
  //                       fontSize: 12.sp,
  //                     ),
  //                   ),
  //                 ),
