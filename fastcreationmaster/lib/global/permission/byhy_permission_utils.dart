...
import 'package:fast_creation_master/global/permission/permissions_usage_dialog.dart';
import 'package:fast_creation_master/main.dart';
      ...
      case Permission.microphone:
        return [
          PermissionUsageBean.fromJson({
            "permissionName": "录制音频",
            "usage":
            "为了给您提供便捷的服务，方便您上传原生视频文件以便与在线客服沟通，我们需要获取您的媒体权限。是否同意？",
          })
        ];
      case Permission.storage:
        return [
          PermissionUsageBean.fromJson({
            ...
            "usage":
            "为了给您提供便捷的服务，方便您上传原生文件以便与在线客服沟通，我们需要获取您的媒体权限。是否同意？",
          })
        ];
      ...
      case Permission.camera:
        return [
          PermissionUsageBean.fromJson({
            ...
            "usage":
            "为了给您提供便捷的服务，我们将获取拍摄照片和录制视频权限，用于与在线客服沟通。是否同意？",
          }),
    ...
    if (status.isGranted || status.isLimited) {
      if(Platform.isIOS){
        if(permission==Permission.camera){
          ...
          late PermissionStatus permissionStatus2 ;
          if(needMicroPhone){
            permissionStatus2 = await Permission.microphone.request();
          }
