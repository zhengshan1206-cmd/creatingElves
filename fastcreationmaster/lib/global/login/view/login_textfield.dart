...
import '../../../core/util/by_string_utils.dart';
...
class _LoginTextFieldState extends State<LoginTextField> {
  ...
  _body() {
    ...
    // 默认颜色
    var textColor = ByColorUtil.colorC1;
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              fillColor: ByColorUtil.colorBg2,
              filled: true,
              ...
              focusedBorder: widget.border ??
                  OutlineInputBorder(
                    borderSide: const BorderSide(
                        color: ByColorUtil.colorC1, width: 1.0),
                    borderRadius: BorderRadius.circular(12.w),
                  ),
            ...
            // 每次输入框文字改变，均会执行
            onChanged: (value) {
              final phone = ByStringUtils.trimWithPhoneNum(value);
