...
class ByColorUtil {
  ...
  */
  ///品牌色、交互主色、选中色
  static const colorC1 = Color(0xFF98FC4A);
  ...
  */
  ...
  /*
    文本颜色
  */
  static const colorF1 = Color(0xFFFFFFFF);

  ///重要文字、大标题
  static const colorF2 = Color(0xFFA0A0A7);

  ///创建专业版字体
  static const colorPro = Color(0xFF8F52FF);
  ...
  static const colorF7 = Color(0xFF162408);
  ...
  */
  static colorG1() {
    return const LinearGradient(
        colors: [Color(0xFF98FC4A), Color(0xFFD7F97D)],
  ...
  ///新春色
  static const colorG5 = Color(0xFFF91F29);

  ///新春副色
  static const colorG6 = Color(0xFFFFDB94);
  ...
  static LinearGradient linearGradientMultipleWithColorsString({
    ...
    final colors = colorsStr.map((e) => ByColorUtil.hexToColor(e)).toList();
  ...
  static LinearGradient linearGradientMultipleWithHexaColorsString({
    ...
    final colorsStr = colorsString.split(",");
    final colors = colorsStr.map((e) => ByColorUtil.hexaToColor(e)).toList();
    final step = 1 / (colors.length - 1);
    final List<double> stops = colors.map((e) {
      return step * (colors.indexOf(e));
    }).toList();
