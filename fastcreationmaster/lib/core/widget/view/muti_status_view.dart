...
class _MultiStatusViewState extends State<MultiStatusView>
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: widget.noNetWorkWidget != null
                  ...
                  : [
                      ByWidgetsUtil.commonText(text: "网络错误，请先打开网络", fontSize: 16.sp, textColor: ByColorUtil.colorF2),
                      SizedBox(
                        height: 20.w,
                      ),
                      SizedBox(
  ...
  _getActions(EmptyActionType emptyActionType) {
    switch (emptyActionType) {
      case EmptyActionType.all:
        return [
          ByWidgetsUtil.commonText(text:  widget.emptyText ?? '暂无内容', fontSize:  16.sp,
  ...
  Widget loadingIndicator(
    {Color color = ByColorUtil.colorC1,}) {
  return const Center(
        child: LoadingView(),);
}
}
