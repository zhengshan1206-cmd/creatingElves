...
class MemberCenterVerticalPage extends BasePage {
  MemberCenterVerticalPage({super.key});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() {
                  return controller.tabCurrentIndex.value == 0 && controller.newVipList.isNotEmpty ? Padding(
  ...
  Widget _buildTabTitle() {
    return Obx(() {
      return Row(
        ...
        children: [
          // 第一个Tab
          if (controller.userInfo.value?.isVip == 0)
            Expanded(
              child: GestureDetector(
                onTap: () {
          ...
          // ),
          // 第二个Tab
          if (controller.userInfo.value?.isVip == 1)
            Expanded(
              child: GestureDetector(
                onTap: () {
                  _pageController.animateToPage(
